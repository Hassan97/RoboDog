...
#define BTN_LEFT            _BV(ControlStick::BTN_DPAD_LEFT)
#define BTN_RIGHT           _BV(ControlStick::BTN_DPAD_RIGHT)
#define BTN_HEIGHT_DEC      _BV(ControlStick::BTN_L1)
#define BTN_HEIGHT_INC      _BV(ControlStick::BTN_R1)
#define BTN_FORWARD         _BV(ControlStick::BTN_DPAD_UP)
#define BTN_BACKWARD         _BV(ControlStick::BTN_DPAD_DOWN)
